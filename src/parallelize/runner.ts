import { type Update } from "https://deno.land/x/grammy_runner@v2.0.3/deps.deno.ts";
import {
    createConcurrentSink,
    type SinkOptions,
    type UpdateConsumer,
    type UpdateSink,
} from "https://deno.land/x/grammy_runner@v2.0.3/sink.ts";
import {
    createSource,
    type SourceOptions,
    type UpdateSource,
    type UpdateSupplier,
} from "https://deno.land/x/grammy_runner@v2.0.3/source.ts";
